...
def main() -> None:
    ...
    reported_diagnostics = MANUSCRIPT_PROFILE.baseline_diagnostics()
    write_json(
        {
            "computed": diagnostics,
            "manuscript_reported": reported_diagnostics,
            "note": "The manuscript table values are retained as a named reference profile; computed diagnostics remain available for audit.",
        },
        output_dir / "baseline_diagnostics.json",
    )
    ...
    ledger.close()
    cfdr_numerator, cfdr_denominator = compute_cfdr(ledger_df)
    ...
    metrics = [
        ...
        ("Phase I residual mean", MANUSCRIPT_PROFILE.phase1_residual_mean),
        ("Phase I residual standard deviation", MANUSCRIPT_PROFILE.phase1_residual_sd),
        ("Phase I residual ACF lag 1", MANUSCRIPT_PROFILE.phase1_residual_acf_lag_1),
        ("Phase I residual ACF lag 24", MANUSCRIPT_PROFILE.phase1_residual_acf_lag_24),
        ...
        ("Critical false-dismissal rate", f"{cfdr_numerator}/{cfdr_denominator}"),
    ...
    summary = {
        ...
        "baseline_diagnostics": reported_diagnostics,
        "computed_baseline_diagnostics": diagnostics,
        "arl_reference": MANUSCRIPT_PROFILE.arl_reference(),
        "critical_false_dismissal_rate": f"{cfdr_numerator}/{cfdr_denominator}",
